<x-app-layout>
    ...
    <div class="container mx-auto">
     ...
     <div class="mb-4">
         <a href="{{ route('users.create') }}" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">Ajouter un Utilisateur</a>
     </div>
         ...
         <tbody>
             ...
             <tr>
                 ...
                 <td class="p-2 border border-gray-400">
                     <a href="{{ route('users.show', $user->id) }}" class="px-2 py-1 bg-blue-500 text-white rounded hover:bg-blue-600">Voir</a>
                     <a href="{{ route('users.edit', $user->id) }}" class="px-2 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600">Modifier</a>
