<x-app-layout>
    ...
    <div class="container mx-auto">
        ...
        <div class="mb-4">
            <a href="{{ route('users.create') }}"
                class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">Ajouter un Utilisateur</a>
        </div>
    ...
    <div class="container mx-auto">
        <h1 class="text-2xl font-bold my-4">Liste des Partners</h1>
        ...
        <table class="w-full border-collapse border border-gray-400">
            ...
            <tbody>
                @foreach ($users as $user)
                    @if ($user->roles->contains('nom', 'partner'))
                        <tr>
                            <td class="p-2 border border-gray-400">{{ $user->id }}</td>
                            <td class="p-2 border border-gray-400">{{ $user->nom }}</td>
                            <td class="p-2 border border-gray-400">{{ $user->prenom }}</td>
